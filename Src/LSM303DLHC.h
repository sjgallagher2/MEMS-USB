/**
  ...
  * @author  MCD Application Team (edited by Sam Gallagher)
  * @version V1.0.0
  * @date    11-September-2013 (edited 25-July-2017)
...
#define LSM303DLHC_MAX_COMMUNICATION_FREQ   ((uint32_t) 100000) // 100kHz
